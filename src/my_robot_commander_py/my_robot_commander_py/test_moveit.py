...
def main(args=None):
    ...
    # joint_values = {
    #     "joint1_base_shoulder": 0.5,
    #     "joint2_shoulder_arm": 0.5,
    #     "joint3_arm_elbow": 0.5,
    #     "joint4_elbow_forearm": 0.5,
    #     "joint5_forearm_wrist": 0.5,
    #     "joint6_wrist_hand": 0.5
    # }
    ...
    q_x, q_y, q_z, q_w = tft.quaternion_from_euler(3.14, 0.0, 0.0)
    pose_goal = PoseStamped()
    pose_goal.header.frame_id = "base_link"
    pose_goal.pose.position.x = 0.0
    pose_goal.pose.position.y = -0.07
    ...
    arm.set_start_state_to_current_state()
    arm.set_goal_state(pose_stamped_msg=pose_goal, post_link="tool_link")
    plan_result = arm.plan()
    if plan_result:
        robot.execute(plan_result.trajectory, controllers=[])
